...
HD_PWD='C:/Users/janarthanan.ak/Desktop/lab0_aj/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteenbit_alu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sixteenbit_alu_top.tcl
