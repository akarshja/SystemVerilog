...
HD_PWD='C:/Users/janarthanan.ak/Desktop/lab0_aj/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteenbit_alu_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sixteenbit_alu_top.tcl -notrace
