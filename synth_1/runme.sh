...
HD_PWD='C:/Users/akars/Downloads/Vivado Projects/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_regfile_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_regfile_top.tcl
