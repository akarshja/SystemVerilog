...
HD_PWD='C:/Users/akars/Downloads/Vivado Projects/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_regfile_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_regfile_top.tcl -notrace
