...
HD_PWD='C:/Users/janarthanan.ak/Desktop/lab0_aj/lab1/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteenbit_adder_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sixteenbit_adder_top.tcl -notrace
