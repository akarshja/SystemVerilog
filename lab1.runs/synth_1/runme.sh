...
HD_PWD='C:/Users/janarthanan.ak/Desktop/lab0_aj/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteenbit_adder_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sixteenbit_adder_top.tcl
